...
class Settings(BaseSettings):
    ...
    DEFAULT_MODEL: str = "gemini-2.0-flash" # Atualizar com frequência a partir de https://ai.google.dev/gemini-api/docs/models
    MODELS_LIST: list[str] = ["gemini-2.0-flash", "gemini-2.5-pro", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-3.1-pro-preview", "gemini-3-flash-preview", "gemini-3.1-flash-lite-preview"]
